""" Electronics routes. """
from apps.electronics.views import electronic_add, electronics_list, edit_electronic, delete_electronic, favorit_control
...
urlpatterns = [
    ...
    path('favorito/<int:id>/', favorit_control, name='favorit_control'),
